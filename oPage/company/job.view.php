            ...
            <div class="row">
                ...
                <div class="col-7 pl-0 ml-0">
                    <div class="star_rating pull-right p-2 xxs_content">
                        <span class="badge-warning btn-round xxs_content">적합도</span>
                        <i class="text-warning xi-star"></i>
                        <i class="text-warning xi-star"></i>
                        <i class="text-warning xi-star-o"></i>
                    </div>
                    <div class="clearfix"></div>
                    <h6 class="weight_normal my-1 text-left">나상호 (56세)</h6>
                    <p class="m-0 text-left weight_lighter xs_content">한 곳에서 묵묵히 오래...</p>
                    <p class="text-left xs_content p-0 m-0"><span class="bg-red icon_wrap"><i class="xi-wrench"></i></span> 경력 : 기계/제조/연구직</p>
                </div>
            </div>
