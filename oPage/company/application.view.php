    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content text-center" style="border-radius:10px">
            ...
            <div class="content_padding">
                ...
                <button onclick="jQuery('#interview_suggestion').modal('hide');jQuery('#interview_sms').modal('show');" class="btn btn-block btn-danger btn-round mt-3">문자메세지 발송</button>
...
<div class="modal fade" id="interview_sms" tabindex="-1" role="dialog" aria-labelledby="tech_forest_modal_window" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content text-center" style="border-radius:10px;">
            <a href="#" class="text-white pull-right text-right" style="margin-top:-40px;" onclick="jQuery('#interview_sms').modal('hide');jQuery('#interview_suggestion').modal('show');" ><i class="xi-close xi-2x"></i></a>
            <div class="square avatar bg-red mx-auto" style="width:120px; margin-top:-60px; background-image:url('/oPage/ncenter/images/header_icon.png');"></div>
            ...
            <button class="mt-2 btn btn-block btn-light" onclick="jQuery('#interview_sms').modal('hide');jQuery('#interview_suggestion').modal('show');" style="border-radius:10px;">취소</button>
        </div>
    </div>
</div>
<?php
