  					...
  					<?	}
  						...
  						echo "<div class=\"d-md-none padding_5 border1_not_top_xs_null font_size_20 align_center padding_top_30 padding_bottom_30\">";
  							...
  							if($date_now > strtotime($hire_info[0]["job_end_date"]) ){
  								echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_application\" rel=\"nofollow\"><button class=\"btn btn-block btn-primary d-md-none\" style=\"font-size: 19px;\" ><strong>지원하기.</strong></button></a>";
  							}
  							else if($m_idx > 0) {
  								echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_application\" rel=\"nofollow\"><button class=\"btn btn-block btn-primary d-md-none\" style=\"font-size: 19px;\" ><strong>지원하기</strong></button></a>";
  							} else {
  								echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_login\" rel=\"nofollow\"><button class=\"btn btn-block btn-primary d-md-none\" style=\"font-size: 19px;\" ><strong>지원하기</strong></button></a>";
  							}
  						echo "</div>";
  					}
  				?>
  				...
  				<?
  					if($logged_info['is_commerce'] == 'Y') {
  						...
  						echo "<div class=\"padding_15 border1_xs_null font_size_20\">";
  							...
  							if($m_idx > 0) {
  								if($career_n==1){
  									echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_application\" rel=\"nofollow\"><button class=\"btn button1\" style=\"font-size: 19px;\" ><strong>지원하기</strong></button></a>";
  								}
  								if($career_n==0){
  									echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_career_n\" rel=\"nofollow\"><button class=\"btn button1\" style=\"font-size: 19px;\" ><strong>지원하기</strong></button></a>";
  								}
  							} else {
  								echo "<a href=\"#\" type=\"button\" role=\"button\" data-toggle=\"modal\" data-target=\"#modal_login\" rel=\"nofollow\"><button class=\"btn button1\" style=\"font-size: 19px;\" ><strong>지원하기</strong></button></a>";
  							}
  						echo "</div>";
  					}
  				?>
