...
<section class="bg-white container">
    ...
    <div class="row rounded overflow-hidden">
        ...
        <div class="py-2 col-sm-8 col-md-9 col-lg-10 bg-light">맡은 일을 책임감 있게 처리하는 숙련기술자 입니다.</div>
    </div>
    </div>
    ...
    <div class="row my-4 pt-4">
        ...
        <div class="col-sm-8 col-md-9 col-lg-10 ">
            <h3 class="px-2">기술자 <span class="sm_content">| 남자</span></h3>
            <table class="table table-borderless">
                <cols>
                    <col width="120" />
                    <col width="*" />
                </cols>
                <tr><th>생년월일</th><td>1970년 12월 29일 (40세)</td></tr>
                <tr><th>연 락 처</th><td>010-1342-4212</td></tr>
                <tr><th>이 메 일</th><td>abcdmart@market.com</td></tr>
                <tr><th>주&nbsp;&nbsp;&nbsp;소</th><td>경남 창원시 마산회원구 봉안북 n길</td></tr>
            </table>
        </div>
    </div>
    ...
    <h5 class="bg-light px-2 py-3 mt-5"><span class="red">*</span>경력 간단요약</h5>
    <p>10년간 RIG용접, CO2용접을 해왔습니다. 도면설계도 가능합니다.</p>
    ...
    <table class="table table-borderless">
        ...
        <tr><th>2009.05</th><td>기술고등학교 졸업 | 기계전공</td></tr>
        <tr><th>2009.05</th><td>기술고등학교 졸업 | 기계전공</td></tr>
    </table>
