...
<div class="container pt-lg-5 pb-5 bg-white">
    <div class="mx-lg-auto col-lg-10 py-lg-5 pt-lg-3">
        ...
        <a class="service_card mb-5 bg-white shadow" id="premium_service">
            <div class="row">
                ...
                <div class="col-12 col-lg-4 py-lg-4 text-center text-lg-left">
                    <div class="px-3 pb-2 pt-4 px-lg-0">
                        <span class="btn btn-danger btn-lg d-lg-inline-block d-none position-static btn-xs py-2 px-4 mb-3">개인</span>
                        <h4 class="weight_bold">프리미엄 회원</h4>
                        <h6 class="weight_lighter">프리미엄 회원권을 이용해보세요.</h6>
                    </div>
                    <div class="d-none d-lg-block red">
                        서비스 자세히보기
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
  $('#premium_service').click(function(){
    alert("☎ 1800-9665 기술자숲으로 별도로 문의바랍니다.");
  });
</script>
