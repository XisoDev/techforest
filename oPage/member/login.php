...
<script type="text/javascript">
  ...
  // 네이버 - 개인회원가입
    ...
    var state = '<?=$_SESSION['state']?>';
		...
		var url = "https://nid.naver.com/oauth2.0/authorize?client_id=9TWCl12zse_283Kcwhc9&response_type=code&redirect_uri=https://gsjsoop.com/login_naver.php?type=1&state=" + state;
	...
	$("#modal_naver_ok2").click(function(e) {
		var state = '<?=$_SESSION['state']?>';
		var href = location.href.replace("#", "");
		var url = "https://nid.naver.com/oauth2.0/authorize?client_id=9TWCl12zse_283Kcwhc9&response_type=code&redirect_uri=https://gsjsoop.com/login_naver.php?type=2&state=" + state;
