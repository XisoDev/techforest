...
<div class="container pt-lg-5">
    <div class="p-3 px-0 d-lg-none">
        ...
        <h4 class="weight_normal">아이디・비밀번호 관리</h4>
    </div>
    ...
    <form class="tf_underline_form">
        <div class="form-group">
            <label for=""><img src="/oPage/images/imgicons/key_gray.png" height="12" class="imgicon" /> <span class="weight_bold">아이디</span> </label><br>
