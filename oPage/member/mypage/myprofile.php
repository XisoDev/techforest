          ...
          <div class="form-group">
            <?$phonenumber = explode("-", $logged_info['m_phone']);?>
              ...
              <div id="select_phone" style="display:none;">
                ...
                <input type="text" class="form-control" id="m_phonenumber2" maxlength="4" value="<?=$phonenumber[1]?>">
                <div class="form-group-prepend">
                    <span class="form-group-text">-</span>
                </div>
                <input type="text" class="form-control" id="m_phonenumber3" maxlength="4" value="<?=$phonenumber[2]?>">
              </div>
