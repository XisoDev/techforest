...
class Object
{
     ...
     * @return void
     */
    function Object($error = 0, $message = '성공적으로 반영되었습니다.')
    {
        $this->setError($error);
    ...
    function setSession()
    {
        $_SESSION['_XISO_ERROR_'] = $this->error;
        $_SESSION['_XISO_MESSAGE_TYPE_'] = $this->error < 0 ? "danger" : "info";
        $_SESSION['_XISO_MESSAGE_'] = $this->message;
    }
